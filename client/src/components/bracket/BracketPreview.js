...
export default function BracketPreview(BracketInfo){
    ...
    return(
      <li>
        <a href={ "/events/" + BracketInfo.event_id + "/bracket/" + BracketInfo.id}>
            ...
            <div className="highlight-left extra-space">
                {BracketInfo.name}
                <br/>
                <span className="preview-sub">Style</span><br/>
                <span className="preview-text no-wrap">{ bracketStyle }</span><br/>
                <span className="preview-sub">Participants</span><br/>
                <span className="preview-text no-wrap">{ BracketInfo.participants.length }</span>
            </div>
